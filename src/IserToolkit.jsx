      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            width: 200,
            height: 200,
            background: `radial-gradient(circle, ${currentProfile.color}18 0%, transparent 70%)`,
            pointerEvents: "none",
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.6)" }}>
              {deviceInfo.rom} · Android {deviceInfo.android}
            </span>
          </div>
        </div>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <span style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: 1 }}>{s.label}</span>
                <span style={{ fontSize: 11, color: s.color }}>{s.value}{s.unit} · {s.temp}°C</span>
              </div>
          ...
          {[
            ...
            <div key={s.label}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <span style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: 1 }}>{s.label}</span>
                <span style={{ fontSize: 11, color: s.color }}>{s.unit}</span>
              </div>
              <StatBar value={s.value} max={s.max} color={s.color} />
            </div>
          ))}
        ...
        <div style={{ padding: "16px 16px 0" }}>
          <div style={{
            ...
            <span style={{ fontSize: 11, color: currentProfile.color, fontWeight: 600 }}>
              {currentProfile.icon} {currentProfile.label}
            </span>
          </div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {profiles.map(p => (
              ...
              >
                ...
                <span style={{
                  fontSize: 9,
                  color: activeProfile === p.id ? p.color : "rgba(255,255,255,0.35)",
                  fontWeight: activeProfile === p.id ? 700 : 400,
                  textAlign: "center",
                  lineHeight: 1.2,
                }}>{p.label}</span>
              </button>
          ...
          <div style={{
            marginTop: 8,
            padding: "8px 12px",
            background: `${currentProfile.color}10`,
            border: `1px solid ${currentProfile.color}25`,
            borderRadius: 10,
            display: "flex",
            alignItems: "center",
            gap: 8,
            ...
            <span style={{
              ...
              fontWeight: 600,
              background: `${currentProfile.color}20`,
              padding: "2px 8px",
              borderRadius: 99,
              flexShrink: 0,
            }}>ACTIVE</span>
        ...
        <div style={{
          ...
          {[
            ...
            >
              <span style={{
                fontSize: 20,
                color: activeTab === tab.id ? "#00C2FF" : "rgba(255,255,255,0.25)",
